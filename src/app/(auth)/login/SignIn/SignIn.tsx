...
import { FaTruck, FaShieldAlt, FaClock, FaStar, FaLock, FaUsers } from "react-icons/fa"
...
export default function LoginPage() {
  ...
  function mySubmit(data: LoginSchemaType) {
      ...
      <div className="w-full max-w-4xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="flex flex-col items-center text-center gap-4">
          ...
          <div className="flex items-center justify-center gap-5 flex-wrap">
            ...
            <span className="flex items-center gap-1.5 text-xs text-gray-600">
              <FaShieldAlt className="text-green-500" size={13} /> Secure Payment
            </span>
            <span className="flex items-center gap-1.5 text-xs text-gray-600">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <div className="flex flex-col gap-3 mb-5">
            ...
            <button className="flex items-center justify-center gap-3 border border-gray-200 hover:bg-gray-50 rounded-xl py-2.5 text-sm font-medium text-gray-700 transition-colors w-full">
              <SiFacebook size={18} className="text-blue-600" /> Continue with Facebook
            </button>
          </div>
